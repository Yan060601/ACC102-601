...
-Steps:Financial analysis about two companies' financial: 1.Import WRDS and make preparations(For instance, import panda); 2.List all the conditions we want to research;3.Find AAPL and MFC's data;4.Clean the data(Get ROA,ROE,Revenue growth rate,current ration and net profit margin);5.Draw the diagram;
-Additional research: 6.Apple's sale and COVID19's relationship
-How to run the code: 1.import wrds, 2. make preparations, 3,find all conditions and two companies' data, 4,cleaning the data, 5, data visualiazation
## 6. Demo Video Link
